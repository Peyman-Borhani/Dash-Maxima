...
<div  class ="inline-grid  absolute  portrait:fixed   items-center  portrait:bottom-8  select-none bg-none  row-start-1  col-start-1 
            {view? 'fixed  rounded-r-xl  scale-150  landscape:-translate-x-52  mt-28'  :'rounded-full  hover:scale-150 '}
